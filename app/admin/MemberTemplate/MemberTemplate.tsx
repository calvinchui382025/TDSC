...
export function MemberTemplate(adminSelectedRange: string, adminEmailBody: string, adminEmailSignOff: string) {
  const showSignOFf = adminEmailSignOff.length > 0;
    ...
    <Html style={root}>
      ...
      <Section style={textSection}>
        <Container style={textContainer}>
          <Text style={heading}>{adminSelectedRange}</Text>
          <Text style={paragraph}>{adminEmailBody}</Text>
        </Container>
      </Section>
      ...
      <Section>
        <Container>
          ...
          <Text style={signOffText}>{adminEmailSignOff}</Text>
        </Container>
      </Section>
      )}
      ...
      <Section style={footerSection}>
        <Text>
          Texas Defensive Shooting Club | {addresses[adminSelectedRange] || 'Houston, TX'}
        </Text>
